...
HD_PWD='D:/Xilinx/Project/200t/Quadrature_Demodulation/Quadrature_Demodulation.runs/bram_16x2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_16x2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_16x2048.tcl
