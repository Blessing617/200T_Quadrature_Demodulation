...
HD_PWD='D:/Xilinx/Project/200t/Quadrature_Demodulation/Quadrature_Demodulation.runs/cic_compiler_16bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cic_compiler_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cic_compiler_16bit.tcl
