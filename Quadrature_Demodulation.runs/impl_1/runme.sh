...
HD_PWD='D:/Xilinx/Project/200t/Quadrature_Demodulation/Quadrature_Demodulation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Quadrature_Demodulation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Quadrature_Demodulation.tcl -notrace
