...
HD_PWD='D:/Xilinx/Project/200t/Quadrature_Demodulation/Quadrature_Demodulation.runs/cic_14BITS_1250_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cic_14BITS_1250.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cic_14BITS_1250.tcl
