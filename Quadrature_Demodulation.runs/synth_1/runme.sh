...
HD_PWD='D:/Xilinx/Project/200t/Quadrature_Demodulation/Quadrature_Demodulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Quadrature_Demodulation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Quadrature_Demodulation.tcl
