...
#                script (type 'cic_compiler_16bit.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cic_compiler_16bit xil_defaultlib.glbl -o cic_compiler_16bit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cic_compiler_16bit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cic_compiler_16bit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cic_compiler_16bit_simv.daidir vcs_lib c.obj)
