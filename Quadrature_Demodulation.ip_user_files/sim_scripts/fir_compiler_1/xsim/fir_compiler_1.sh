...
#
# Script generated by Vivado on Mon Mar 11 15:31:44 +0800 2024
...
# script info
echo -e "fir_compiler_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L fir_compiler_v7_2_19 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fir_compiler_1 xil_defaultlib.fir_compiler_1 xil_defaultlib.glbl -log elaborate.log
}
