...
#
# Script generated by Vivado on Mon Mar 11 15:57:18 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : cic_14BITS_1250.sh
...
#
# Usage        : cic_14BITS_1250.sh
#                cic_14BITS_1250.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cic_14BITS_1250.sh [-reset_run]
#                cic_14BITS_1250.sh [-reset_log]
#                cic_14BITS_1250.sh [-help]
#
...
# script info
echo -e "cic_14BITS_1250.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cic_14BITS_1250.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L cic_compiler_v4_0_16 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cic_14BITS_1250 xil_defaultlib.cic_14BITS_1250 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cic_14BITS_1250 -key {Behavioral:sim_1:Functional:cic_14BITS_1250} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cic_14BITS_1250.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cic_14BITS_1250.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cic_14BITS_1250.sh [-help]\n\
Usage: cic_14BITS_1250.sh [-step]\n\
Usage: cic_14BITS_1250.sh [-lib_map_path]\n\
Usage: cic_14BITS_1250.sh [-reset_run]\n\
Usage: cic_14BITS_1250.sh [-reset_log]\n\
Usage: cic_14BITS_1250.sh [-keep_index]\n\
Usage: cic_14BITS_1250.sh [-noclean_files]\n\n\
