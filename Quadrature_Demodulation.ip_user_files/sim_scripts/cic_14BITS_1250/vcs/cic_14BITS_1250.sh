...
#                script (type 'cic_14BITS_1250.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cic_14BITS_1250 xil_defaultlib.glbl -o cic_14BITS_1250_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cic_14BITS_1250_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cic_14BITS_1250_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cic_14BITS_1250_simv.daidir vcs_lib c.obj)
