...
#
# Script generated by Vivado on Mon Mar 11 15:40:29 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : bram_16x2048.sh
...
#
# Usage        : bram_16x2048.sh
#                bram_16x2048.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_16x2048.sh [-reset_run]
#                bram_16x2048.sh [-reset_log]
#                bram_16x2048.sh [-help]
#
...
#                script (type 'bram_16x2048.sh -help' for more information).
#
...
# script info
echo -e "bram_16x2048.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_16x2048.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_16x2048 xil_defaultlib.glbl -o bram_16x2048_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_16x2048_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_16x2048_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_16x2048_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_16x2048.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_16x2048.sh [-help]\n\
Usage: bram_16x2048.sh [-step]\n\
Usage: bram_16x2048.sh [-lib_map_path]\n\
Usage: bram_16x2048.sh [-reset_run]\n\
Usage: bram_16x2048.sh [-reset_log]\n\
Usage: bram_16x2048.sh [-keep_index]\n\
Usage: bram_16x2048.sh [-noclean_files]\n\n\
