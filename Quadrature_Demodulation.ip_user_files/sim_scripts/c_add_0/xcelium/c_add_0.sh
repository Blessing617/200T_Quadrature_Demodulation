...
#
# Script generated by Vivado on Mon Mar 11 15:44:22 +0800 2024
...
#
# Usage        : c_add_0.sh
#                c_add_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_add_0.sh [-reset_run]
#                c_add_0.sh [-reset_log]
#                c_add_0.sh [-help]
#
...
#                script (type 'c_add_0.sh -help' for more information).
#
...
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "c_add_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_add_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.c_add_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.c_add_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log c_add_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: c_add_0.sh [-step]\n\
Usage: c_add_0.sh [-lib_map_path]\n\
Usage: c_add_0.sh [-reset_run]\n\
Usage: c_add_0.sh [-reset_log]\n\
Usage: c_add_0.sh [-keep_index]\n\
